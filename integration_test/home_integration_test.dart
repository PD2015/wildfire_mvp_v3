...
void main() {
  ...
  group('Home Screen Integration Tests (On Device)', () {
    ...
    testWidgets(
      'Location resolution works (GPS, cache, or fallback)',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Fire risk colors match FWI thresholds',
      (WidgetTester tester) async {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final updatedFinder = find.textContaining(
          'Updated',
          findRichText: true,
        );
    ...
    testWidgets(
      'Retry button appears and works after error',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Touch targets meet 44dp minimum (C3 accessibility)',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Manual location entry dialog can be opened',
      (WidgetTester tester) async {
        ...
        for (final trigger in manualEntryTriggers) {
          ...
          if (finder.evaluate().isNotEmpty) {
            ...
            final latField = find.textContaining(
              'Latitude',
              findRichText: true,
            );
            final lonField = find.textContaining(
              'Longitude',
              findRichText: true,
            );
    ...
    testWidgets(
      'View Map navigation button is visible and accessible (C3)',
      (WidgetTester tester) async {
