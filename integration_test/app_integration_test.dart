...
void main() {
  ...
  group('App Navigation Integration Tests (Full Journey)', () {
    ...
    testWidgets(
      'Navigate from Home to Map screen',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Navigate back to Home from Map screen',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Fire risk data persists across navigation',
      (WidgetTester tester) async {
        ...
        final afterNavRiskText = find.textContaining(
          'Risk',
          findRichText: true,
        );
        expect(
    ...
    testWidgets(
      'Multiple back-and-forth navigations work correctly',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'App handles rapid navigation without crashes',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Bottom navigation (if present) highlights correct tab',
      (WidgetTester tester) async {
  ...
  group('App Lifecycle Integration Tests', () {
    testWidgets(
      'App resumes from background without data loss',
      (WidgetTester tester) async {
