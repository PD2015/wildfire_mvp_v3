  ...
  group('ManualLocationDialog Widget Tests', () {
    ...
    testWidgets('accepts valid coordinate input with proper formatting',
      ...
      await tester.enterText(
          find.byKey(const Key('latitude_field')), '55.9533');
      await tester.enterText(
          find.byKey(const Key('longitude_field')), '-3.1883');
      await tester.pumpAndSettle();
    ...
    testWidgets('rejects invalid coordinate ranges with clear error messages',
      ...
      expect(find.textContaining('Latitude must be between -90 and 90 degrees'),
          findsOneWidget);
    ...
    testWidgets('input formatters prevent invalid characters', (tester) async {
      ...
      await tester.enterText(
          find.byKey(const Key('latitude_field')), 'abc123.45def');
      await tester.enterText(
          find.byKey(const Key('longitude_field')), 'xyz-67.89ghi');
      await tester.pumpAndSettle();

      // Assert - Only valid numeric characters should remain (letters filtered out)
      final latField =
          tester.widget<TextField>(find.byKey(const Key('latitude_field')));
      final lonField =
          tester.widget<TextField>(find.byKey(const Key('longitude_field')));
    ...
    group('Touch Target Size Validation (Gate C3)', () {
      testWidgets('all interactive elements meet 44dp minimum size requirement',
        ...
        final cancelButtonSize =
            tester.getSize(find.byKey(const Key('cancel_button')));
        final saveButtonSize =
            tester.getSize(find.byKey(const Key('save_button')));
        ...
        final latFieldSize =
            tester.getSize(find.byKey(const Key('latitude_field')));
        final lonFieldSize =
            tester.getSize(find.byKey(const Key('longitude_field')));
    ...
    group('Accessibility Compliance (Gate C3)', () {
      ...
      testWidgets('semantic labels are meaningful and not generic',
        ...
        final latFieldSemantics =
            tester.getSemantics(find.byKey(const Key('latitude_field')));
        final lonFieldSemantics =
            tester.getSemantics(find.byKey(const Key('longitude_field')));
    ...
    group('Button Behavior', () {
      ...
      testWidgets('save button returns valid LatLng when coordinates are valid',
          (tester) async {
        // Arrange
        LatLng? result;
        await tester.pumpWidget(
    ...
    group('Edge Cases', () {
      testWidgets('handles boundary coordinate values correctly',
        ...
        await tester.enterText(
            find.byKey(const Key('longitude_field')), '180.0');
        await tester.pumpAndSettle();
      ...
      testWidgets('handles negative coordinates correctly', (tester) async {
        ...
        await tester.enterText(
            find.byKey(const Key('latitude_field')), '-45.5');
        await tester.enterText(
            find.byKey(const Key('longitude_field')), '-122.3');
        await tester.pumpAndSettle();
