...
void main() {
  group('RiskBanner Golden Test - High Light', () {
    testWidgets('should match golden image for High risk level in light theme', (WidgetTester tester) async {
            ...
            body: Center(
              child: SizedBox(
                ...
                child: RiskBanner(
                  ...
                  locationLabel: 'Stirling (56.12, -3.94)',
                ),
              ),
            ),
          ),
      ...
      await expectLater(
        ...
        matchesGoldenFile('goldens/risk_banner_high_light.png'),
      );
    });
  });
}