...
class A11yHelpers {
  ...
  static void verifyTouchTargetSize(WidgetTester tester, Finder finder) {
    expect(finder, findsOneWidget, reason: 'Widget not found for touch target check');
  ...
  static void verifySemanticLabel(WidgetTester tester, Finder finder, String expectedLabel) {
    expect(finder, findsOneWidget, reason: 'Widget not found for semantic label check');
