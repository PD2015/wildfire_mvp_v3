...
void main() {
  group('EFFIS Response Contract Tests', () {
    ...
    test('edinburgh_success.json should parse to valid FWI result', () async {
      ...
      fail('TODO: Wire to EffisServiceImpl.getFwi() and validate EffisFwiResult creation');
    });
    ...
    test('404.json should map to clientError ApiError', () async {
      ...
      fail('TODO: Wire to EffisServiceImpl error handling and validate ApiError creation');
    });
    ...
    test('503.json should map to serverError ApiError', () async {
      ...
      fail('TODO: Wire to EffisServiceImpl error handling and validate ApiError with retry logic');
    });
    ...
    test('malformed.json should map to parseError ApiError', () async {
      ...
      fail('TODO: Wire to EffisServiceImpl parsing validation and verify ApiError(type: ApiErrorType.parseError)');
    });
    ...
    test('empty_features.json should map to noDataError ApiError', () async {
      ...
      fail('TODO: Wire to EffisServiceImpl and verify ApiError(type: ApiErrorType.noDataError) for empty features');
    });
    ...
    group('Fixture File Integrity', () {
      test('all fixture files exist and are valid JSON', () async {
        ...
        for (final filename in fixtureFiles) {
          ...
          expect(file.existsSync(), isTrue, reason: 'Fixture file $filename should exist');
