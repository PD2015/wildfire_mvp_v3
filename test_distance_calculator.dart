...
void main() {
  debugPrint('🧪 Testing DistanceCalculator utilities for fire information sheet...\n');
  ...
  debugPrint('   Edinburgh → Glasgow: ${(edinToGlasgow / 1000).toStringAsFixed(1)} km');
  debugPrint('   Edinburgh → London: ${(edinToLondon / 1000).toStringAsFixed(1)} km');
  debugPrint('   Edinburgh → New York: ${(edinToNY / 1000).toStringAsFixed(0)} km');
  ...
  debugPrint('   Edinburgh → Glasgow: $cardinalGlasgow (${bearingToGlasgow.toStringAsFixed(0)}°)');
  debugPrint('   Edinburgh → London: $cardinalLondon (${bearingToLondon.toStringAsFixed(0)}°)');
  debugPrint('   Edinburgh → New York: $cardinalNY (${bearingToNY.toStringAsFixed(0)}°)');
  ...
  debugPrint('📋 Task 3: "Implement distance calculation utilities" - COMPLETE ✅');
